...
use super::client::{
    call_llm_structured_limited, call_llm_structured_limited_speed_with_failover,
...
pub async fn verify_changes_bounded_with_model(
    ...
    let response: StructuredResponse<ReviewResponseJson> = if model == Model::Speed {
